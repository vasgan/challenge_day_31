...
android {
    namespace = "com.example.aiplatform"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.aiplatform"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    val openAiKeyFromProperty = (project.findProperty("OPENAI_API_KEY") as String?)
        ?: (project.rootProject.findProperty("OPENAI_API_KEY") as String?)
